...
public class SandboxMapas
{
    ...
    {
    	ArrayList<String> lista = new ArrayList<>(mapaCadenas.values());
    ...
    public String getPrimera( )
    {
        ...
        String primera = Collections.min(mapaCadenas.keySet());
        return primera;
    }
    ...
    public String getUltima( )
    {
        ...
        String ultima = Collections.max(mapaCadenas.values());
        return ultima;
    }
    ...
    {
    	return new ArrayList<>(new HashSet<>(mapaCadenas.values())).size();
    ...
    public void eliminarCadenaConValor( String valor ){
    	String llaveParaEliminar = mapaCadenas.entrySet().stream()
    ...
    public void reiniciarMapaCadenas( List<Object> objetos ){
        ...
        for (Object obj : objetos) {
            ...
            agregarCadena(valor); // Reutilizo el método agregarCadena
        }
    }
